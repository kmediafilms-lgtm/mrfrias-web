                                            ...
                                            <div class="banner-title-area">
                                                <div class="banner-style1">
                                                    <div class="section-title">
                                                        ...
                                                        <div class="mrfrias-hero-btns" data-animation="slideInRight" data-duration="2s" data-delay=".7s">
                                                            <a class="theme-btn" href="#sucursales"><?php echo htmlspecialchars($SITE['hero']['cta_primary']['label']); ?> <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                                            <a class="theme-btn mrfrias-btn-outline d-none d-lg-inline-flex" href="#sucursales">Ver sucursales <i class="fa-sharp fa-regular fa-location-dot"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="container">
            ...
            <div class="slider-area mb-n40">
                <div class="swiper bestFoodItems-slider">
                    <div class="swiper-wrapper">
                        <?php foreach (array_filter($MENU, fn($i) => $i['destacado']) as $item): ?>
                            <div class="swiper-slide">
                        ...
                        <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.<?php echo 2 + ($i % 5); ?>s">
                            <div class="chefe-card style1">
                                ...
                                <div class="chefe-content">
                                    ...
                                    <p class="mrfrias-sucursal-meta"><?php echo htmlspecialchars($s['zona']); ?> &nbsp;·&nbsp; <i class="fab fa-whatsapp"></i> <?php echo htmlspecialchars($s['telefono_visible']); ?></p>
                                    <a class="theme-btn mrfrias-sucursal-wa-btn" href="<?php echo wa_link($s['whatsapp_e164'], $s['mensaje_prellenado']); ?>" target="_blank" rel="noopener">
...
<section id="nosotros" class="mrfrias-acerca-section">
    ...
    <div class="mrfrias-marquee-ghost">
        <div class="mrfrias-marquee-ghost-inner">
            <span>SALCHIPAPAS</span><span>·</span><span>HOT DOGS</span><span>·</span><span>HAMBURGUESAS</span><span>·</span><span>ALITAS</span><span>·</span><span>QUESADILLAS</span><span>·</span><span>WRAPS</span><span>·</span>
            <span>SALCHIPAPAS</span><span>·</span><span>HOT DOGS</span><span>·</span><span>HAMBURGUESAS</span><span>·</span><span>ALITAS</span><span>·</span><span>QUESADILLAS</span><span>·</span><span>WRAPS</span><span>·</span>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                ...
                <p class="mrfrias-respiro-sub"><?php echo htmlspecialchars($SITE['brand']['tagline']); ?></p>
